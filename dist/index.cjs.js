...
var Icon$X = function (props) {
    return (React__default['default'].createElement("img", { src: "/images/new/blovely.png", style: { "paddingRight": "10px", "height": "35px" } }));
};
...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", backgroundAlt: "#FFFFFF", cardBorder: "#E7E3EB", contrast: "#191326", dropdown: "#F6F6F6", dropdownDeep: "#EEEEEE", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#d7caec", tertiary: "#fb7c7e", text: "#fe4350", textDisabled: "#BDC2C4", textSubtle: "#a42c30", disabled: "#E9EAEB", gradients: {
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink, { as: "a", href: href, "aria-label": "BabyLovelySwap home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink, { to: href, "aria-label": "BabyLovelySwap home page" }, innerLogo))));
};
...
var PanelBody = function (_a) {
    ...
    return (React__default['default'].createElement(Container$1, null, links.map(function (entry) {
        ...
        var iconElement = React__default['default'].createElement(Icon, { width: "30px", mr: "8px", padding: "0 0 0 10px" });
            ...
            return (React__default['default'].createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, status: entry.status, initialOpenState: initialOpenState, className: calloutClass, isActive: entry.items.some(function (item) { return item.href === location.pathname; }) }, isPushed &&
                entry.items.map(function (item) { return (React__default['default'].createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick },
                    React__default['default'].createElement(MenuLink, { href: item.href },
                        ...
                        item.status && (React__default['default'].createElement(LinkStatus, { color: item.status.color, fontSize: "18px" }, item.status.text))))); })));
        }
        return (React__default['default'].createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
            React__default['default'].createElement(MenuLink, { href: entry.href, onClick: handleClick },
                ...
                entry.status && (React__default['default'].createElement(LinkStatus, { color: entry.status.color, fontSize: "18px" }, entry.status.text)))));
    })));
};
var templateObject_1$a;
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://babylovelyswap.finance/#/swap?outputCurrency=0x04Df8C91FCcFd703cD15047bF6C1cE76D335C6cE", target: "_blank" },
